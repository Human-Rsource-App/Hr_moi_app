                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(child: _buildInfoColumn('الرتبة',
                              userProfile!.data!.rankName.toString(),
                            )),
                          ],
                        ),
                        const SizedBox(height: 10),
                        _buildInfoColumn('الاسم الكامل',
                          userProfile!.data!.empName.toString(),
                        ),
                        const SizedBox(height: 10),
                        _buildInfoColumn(
                          'الدائرة',
                            userProfile!.data!.unitName.toString(),
                        ),
                        const SizedBox(height: 10),
                        _buildInfoColumn('رقم الهاتف',
                          userProfile!.data!.phoneNo.toString(),
                        ),
                        const SizedBox(height: 10),
                        _buildInfoColumn('الصنف',
                          userProfile!.data!.rkTypeName.toString(),
                        ),
                        const SizedBox(height: 10),
                      ],
                    ),
